...
def test_ui_i18n_catalog_contains_core_shell_and_navigation_keys():
    required_keys = {
        ...
        "label.current_font_scale",
        "locale.ja",
        "locale.en",
        "locale.zh-CN",
        "shell.title",
        "shell.settings",
        "shell.utility_locale",
        "shell.utility_font_scale",
        "shell.root",
        "shell.warning_title",
        "shell.warning_body",
        "settings.title",
        ...
        "ui.template.package_readiness.command.package_review_runtime_handoff",
        "ui.template.package_readiness.command.package_context_runtime_handoff",
        "ui.template.package_readiness.command.package_review_target_handoff",
        "ui.template.package_readiness.command.package_context_target_handoff",
        "ui.template.package_readiness.command.chronicle_show",
        "ui.template.package_readiness.command.review_queue",
        "ui.template.package_readiness.command.generic",
        ...
        "ui.package_readiness.summary.label.unavailable",
        "ui.template.package_readiness.summary.available",
        "ui.package_readiness.summary.message.advisory",
        "ui.package_readiness.summary.message.unavailable",
        ...
        "ui.template.package_handoff.command.package_context_persist",
        "ui.template.package_handoff.command.review_queue",
        "ui.template.package_handoff.command.generic",
        ...
        "ui.template.retrieval_handoff.command.package_context_persist",
        "ui.template.retrieval_handoff.command.review_queue",
        "ui.template.retrieval_handoff.command.generic",
        ...
        "ui.template.invocation_plan.command.review_queue",
        ...
        "ui.ai_index_vector_detail.message.metadata_empty",
        "ui.template.ai_index_vector_detail.counts",
        "ui.ai_index_vector_detail.note.read_only_derived",
        "ui.ai_index_graph_node_detail.message.neighbors_present",
        "ui.ai_index_graph_node_detail.message.no_neighbors",
        "ui.template.ai_index_graph_node_detail.counts",
        "ui.ai_index_graph_node_detail.note.read_only_derived",
...
def test_ui_i18n_catalog_covers_review_action_preview_summary_structured_keys():
    required_keys = {
...
def test_ui_i18n_catalog_covers_review_write_route_status_code_when_keys():
    required_keys = {
...
def test_ui_i18n_catalog_covers_package_preview_and_review_preview_messages():
    required_exact = {
        ...
        "Vector entry has no indexed metadata; treat it as a local derived text-only index row.",
        "Graph node detail includes local derived neighbor relationships for inspection.",
        "Graph node detail has no derived neighbor relationships yet.",
        "Package review passed for the current local context package snapshot.",
        "Package review reported warnings for the current local context package snapshot.",
        "Package review reported blocked findings for the current local context package snapshot.",
        "Package review snapshot is unavailable.",
