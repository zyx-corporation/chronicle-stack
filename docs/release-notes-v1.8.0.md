...
Related: `docs/adr/0023-browser-triggered-review-write-semantics.md`, `docs/adr/0026-local-reviewer-session-proof-representation.md`, `docs/adr/0027-local-gui-review-route-contract.md`, `docs/release-readiness-v1.8.md`, `docs/smoke-test-v1.8.md`
