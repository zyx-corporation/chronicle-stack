...
Related: `docs/release-readiness-v1.17.md`, `docs/release-status-v1.17.0.md`, `docs/release-notes-v1.17.0.md`, `docs/v1.17-release-remaining-issues.md`, `docs/adr/0036-local-readiness-and-expectation-structured-i18n.md`
