...
- external runtime repo `zyx-corporation/chronicle-external-query` can now be designed against a concrete Chronicle-side contract set; see `docs/external-query-runtime-repo-design.md`
