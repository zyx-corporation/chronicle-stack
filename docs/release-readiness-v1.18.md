...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0037-local-package-parity-and-preview-structured-i18n.md`, `docs/release-status-v1.18.0.md`, `docs/smoke-test-v1.18.md`
