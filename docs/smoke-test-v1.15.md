...
Related: `docs/release-readiness-v1.15.md`, `docs/release-status-v1.15.0.md`, `docs/release-notes-v1.15.0.md`, `docs/v1.15-release-remaining-issues.md`, `docs/adr/0034-local-blocker-structured-i18n-contracts.md`
