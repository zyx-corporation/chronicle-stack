...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0034-local-blocker-structured-i18n-contracts.md`, `docs/release-status-v1.15.0.md`, `docs/smoke-test-v1.15.md`
