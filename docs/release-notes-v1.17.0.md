...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0036-local-readiness-and-expectation-structured-i18n.md`, `docs/release-readiness-v1.17.md`, `docs/smoke-test-v1.17.md`
