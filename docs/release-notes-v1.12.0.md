...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0031-local-reviewer-boundary-presentation-drilldown.md`, `docs/release-readiness-v1.12.md`, `docs/smoke-test-v1.12.md`
