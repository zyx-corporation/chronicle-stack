...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0042-local-ai-index-detail-structured-i18n.md`, `docs/release-status-v1.23.0.md`, `docs/smoke-test-v1.23.md`
