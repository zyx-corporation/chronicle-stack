...
Related: `../readiness/release-readiness-v1.47.md`, `../status/release-status-v1.47.0.md`, `../notes/release-notes-v1.47.0.md`, `../../adr/0066-local-review-cli-equivalent-structured-rendering.md`
