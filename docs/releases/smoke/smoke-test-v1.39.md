...
Related: `../readiness/release-readiness-v1.39.md`, `../status/release-status-v1.39.0.md`, `../notes/release-notes-v1.39.0.md`, `../../adr/0058-local-overview-mutation-readiness-action-matrix-rendering.md`
