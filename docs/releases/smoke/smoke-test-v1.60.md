...
Related: `../readiness/release-readiness-v1.60.md`, `../status/release-status-v1.60.0.md`, `../notes/release-notes-v1.60.0.md`, `../../adr/0079-local-target-state-recovery-and-review-capability-status-localization.md`
