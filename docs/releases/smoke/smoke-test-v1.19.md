...
Related: `../readiness/release-readiness-v1.19.md`, `../status/release-status-v1.19.0.md`, `../notes/release-notes-v1.19.0.md`, `../remaining/v1.19-release-remaining-issues.md`, `../../adr/0038-local-navigation-provider-response-and-runtime-preview-structured-i18n.md`
