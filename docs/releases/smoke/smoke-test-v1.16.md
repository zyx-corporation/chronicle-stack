...
Related: `../readiness/release-readiness-v1.16.md`, `../status/release-status-v1.16.0.md`, `../notes/release-notes-v1.16.0.md`, `../remaining/v1.16-release-remaining-issues.md`, `../../adr/0035-local-mutation-enablement-check-structured-i18n.md`
