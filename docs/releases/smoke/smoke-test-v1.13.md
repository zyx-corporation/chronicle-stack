...
Related: `../readiness/release-readiness-v1.13.md`, `../status/release-status-v1.13.0.md`, `../notes/release-notes-v1.13.0.md`, `../remaining/v1.13-release-remaining-issues.md`, `../../adr/0032-local-reviewer-boundary-structured-presentation-contracts.md`
