...
Related: `../readiness/release-readiness-v1.12.md`, `../status/release-status-v1.12.0.md`, `../notes/release-notes-v1.12.0.md`, `../remaining/v1.12-release-remaining-issues.md`, `../../adr/0031-local-reviewer-boundary-presentation-drilldown.md`
