...
Related: `../../adr/0019-local-ui-review-semantics-parity-boundary.md`, `../../v1.7-phase-h-auth-ui-design.md`
...
- review queue / summary jobs list blocked-route preview buttons and CLI fallback response
