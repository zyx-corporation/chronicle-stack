...
Related: `../readiness/release-readiness-v1.8.md`, `../status/release-status-v1.8.0.md`, `../notes/release-notes-v1.8.0.md`, `../remaining/v1.8-release-remaining-issues.md`, `../../adr/0027-local-gui-review-route-contract.md`
