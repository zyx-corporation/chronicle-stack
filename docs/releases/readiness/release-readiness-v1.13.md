...
Related: `../../adr/0025-local-ui-i18n-presentation-boundary.md`, `../../adr/0032-local-reviewer-boundary-structured-presentation-contracts.md`, `../status/release-status-v1.13.0.md`, `../smoke/smoke-test-v1.13.md`
