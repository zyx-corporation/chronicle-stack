...
`../../interface-contracts.md` defines stability levels for JSONL, model serialization, CLI JSON output, export formats, and Python modules.
...
- [v0.3 Smoke Test](../smoke/smoke-test-v0.3.md)
...
4. Complete `../smoke/smoke-test-v0.3.md`.
