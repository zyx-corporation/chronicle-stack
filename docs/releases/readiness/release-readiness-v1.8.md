...
Related: `../../adr/0023-browser-triggered-review-write-semantics.md`, `../../adr/0026-local-reviewer-session-proof-representation.md`, `../../adr/0027-local-gui-review-route-contract.md`, `../status/release-status-v1.8.0.md`, `../smoke/smoke-test-v1.8.md`
