...
| Smoke test document exists | Ready | `../smoke/smoke-test-v0.4.md` |
...
v0.4 is ready to proceed to release smoke testing and final version/tag preparation once `../smoke/smoke-test-v0.4.md` is merged and CI passes.
