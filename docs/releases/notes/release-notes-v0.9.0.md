...
- Contributor license policy draft exists: `../../contributor-license-policy.md`
- Both are treated as draft completed / counsel review pending.

## Documentation

- `../readiness/release-readiness-v0.9.md`
- `../smoke/smoke-test-v0.9.md`
- `../operations/release-deployment-v0.9.md`
- `../../v0.8-package-review-workflow.md`
- `../../v0.7-operational-hardening-plan.md`
