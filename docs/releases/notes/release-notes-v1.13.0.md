...
Related: `../../adr/0025-local-ui-i18n-presentation-boundary.md`, `../../adr/0032-local-reviewer-boundary-structured-presentation-contracts.md`, `../readiness/release-readiness-v1.13.md`, `../smoke/smoke-test-v1.13.md`
