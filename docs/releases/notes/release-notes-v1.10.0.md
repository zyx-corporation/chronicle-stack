...
Related: `../../adr/0025-local-ui-i18n-presentation-boundary.md`, `../../adr/0029-local-reviewer-boundary-observability.md`, `../readiness/release-readiness-v1.10.md`, `../smoke/smoke-test-v1.10.md`
