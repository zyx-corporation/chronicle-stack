...
Related: `../../adr/0034-local-blocker-structured-i18n-contracts.md`, `release-status-v1.14.0.md`

`v1.15.0` is the published local blocker structured-i18n-contract release after the published `v1.14.0` baseline.

- Latest published release: `v1.15.0`
- Release URL: `https://github.com/zyx-corporation/chronicle-stack/releases/tag/v1.15.0`
- Current repository-side release target: `TBD after v1.15.0 publication`
- Lane scope: auth-boundary and mutation-blocker structured i18n contracts only

## Current repository-side progress

Published `v1.15.0` release progress includes:
...
Published `v1.15.0` still must not imply:
