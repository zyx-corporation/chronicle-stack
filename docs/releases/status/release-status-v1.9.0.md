...
- `../../adr/0028-local-reviewer-session-enforcement-boundary.md`
- `../readiness/release-readiness-v1.9.md`
- `../notes/release-notes-v1.9.0.md`
- `../smoke/smoke-test-v1.9.md`
- `../remaining/v1.9-release-remaining-issues.md`

## Historical context

These records provide the immediate upstream context for the `v1.9.0` lane:

- `release-status-v1.8.0.md`
- `../remaining/v1.8-release-remaining-issues.md`
- `../../adr/0026-local-reviewer-session-proof-representation.md`
- `../../adr/0027-local-gui-review-route-contract.md`
