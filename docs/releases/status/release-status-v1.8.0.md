...
- `../readiness/release-readiness-v1.8.md`
- `../notes/release-notes-v1.8.0.md`
- `../smoke/smoke-test-v1.8.md`
...
- `../../v1.7-phase-f-g-h-remaining-issues.md`
- `../../v1.7-phase-h-gated-gui-mutation-preview.md`
