...
Related: `docs/adr/0026-local-reviewer-session-proof-representation.md`, `docs/adr/0028-local-reviewer-session-enforcement-boundary.md`, `docs/release-readiness-v1.9.md`, `docs/smoke-test-v1.9.md`
