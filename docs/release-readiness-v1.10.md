...
Related: `docs/adr/0025-local-ui-i18n-presentation-boundary.md`, `docs/adr/0029-local-reviewer-boundary-observability.md`, `docs/release-status-v1.10.0.md`, `docs/smoke-test-v1.10.md`
