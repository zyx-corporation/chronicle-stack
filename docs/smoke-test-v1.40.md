...
Related: `docs/release-readiness-v1.40.md`, `docs/release-status-v1.40.0.md`, `docs/release-notes-v1.40.0.md`, `docs/adr/0059-local-review-authorization-action-matrix-structured-contracts.md`
